...
const COLONIAS_06600 = [
  ...
  { response: { municipio: "Cuauhtémoc", estado: "Ciudad de México", ciudad: "Ciudad de México", asentamiento: "Tabacalera" } },
]
...
describe("getColonias (application use case)", () => {
  ...
  describe("exports del contrato de aplicación", () => {
    ...
    it("exporta ColoniaServiceError como clase de Error", () => {
      const err = new ColoniaServiceError("El servicio de colonias no está disponible. Intenta más tarde.")
